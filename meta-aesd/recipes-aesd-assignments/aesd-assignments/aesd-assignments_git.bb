...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-kamini2801.git;protocol=ssh;branch=master"
...
do_install () {
	...
	install -m 0755 ${S}/Start_script.sh ${D}${sysconfdir}/init.d
	install -d ${D}${bindir}
